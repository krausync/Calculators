...
# Inserir a taxa mensal separada por ponto e não vírgula, pois o código está como int.
a = int(input("Insira o capital inicial investido = "))
b = int(input("Insira a taxa contrata a.m = "))
c = int(input("Insira a quantidade de meses para investimento = "))
